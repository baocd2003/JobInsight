...
public class MongoDbJobInsightDbSchemaMigrator : IJobInsightDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbJobInsightDbSchemaMigrator(IServiceProvider serviceProvider)
    {
